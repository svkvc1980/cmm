...
<body>
    ...
    <p align="center"><b>C and F Credit/Debit Report</b></p>
    ...
    <table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
        <tr style="background-color:#cccfff">   
            ...
            <th  width="350"> C and F </th>
            <th  width="150"> Purpose</th>
            <th  width="150"> Amount </th>
        </tr>
        
        <?php $sno=1; $credit_amount = 0; $debit_amount = 0;
        if(count($c_and_f_cd_list)>0)
        {
            foreach ($c_and_f_cd_list as $key)
            { 
                if($key['note_type']==1)
                {
            ...
            <tr>
                ...
                <td width="350"><?php echo $key['name']; ?></td>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'cd_candf_r';?>">Back</a>
    </div>
</body>
