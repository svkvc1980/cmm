        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                ...
                <div class="portlet-body">
                    <form method="post" action="<?php echo SITE_URL.'print_dist_cd_report'?>">
                        <div class="row">
                        ...
                        <div class="row">  
                            <div class="form-actions col-md-offset-4 col-md-4">
                                ...
                                <button type="submit" name="download_dist_cd_report" value="download" formaction="<?php echo SITE_URL.'download_dist_cd_report';?>" class="btn blue"><i class="fa fa-cloud-download"></i>Download</button>
                            </div>                               
                        </div>
                    </form> 
                </div>
