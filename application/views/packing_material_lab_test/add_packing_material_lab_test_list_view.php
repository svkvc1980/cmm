                    ...
                    if(isset($flg))
                    {
                        ?>
                            <form id="labtest_form" method="post" action="<?php echo $form_action;?>"  autocomplete="on" class="form-horizontal">
                                <input type="hidden" name="pm_category_id" value="<?php echo cmm_encode($pm_category_id);?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4><?php echo '<b>Packing Material Category:</b>'.@$packing_material;?></h4>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  testname">
                                                ...
                                                <div class="col-xs-10 form-group"> 
                                                    <div class="input-icon right">
                                                        <i class="fa"></i> 
                                                        <input type="text" name="test_name[1]" class="form-control input-sm" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 rangetype">
                                                ...
                                                <div class="col-xs-10 ">  
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <select class="form-control range_type"  name="range_type[1]"  >
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-5 col-md-6">
                                            ...
                                            <a href="<?php echo SITE_URL.'packing_material_lab_test';?>" class="btn default">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
