        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    <form  method="post" action="<?php echo SITE_URL.'add_stock_updation';?>"  class="form-horizontal stock_updation">
                        <div class="row "> 
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Add Quantity(in Sachets) <span class="font-red required_fld">*</span></label>
                                <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                            ...
                            <div class="form-group">
                                <div class="col-md-5"></div>
                                    <div class="col-md-6">
                                        <input type="submit" class="btn blue tooltips" onclick="return confirm('Are you sure you want to Add Stock?')" value="Add Stock" name="submit">
