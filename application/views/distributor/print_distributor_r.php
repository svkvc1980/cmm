...
<body>
    ...
    <p align="center"><b><?php if($distributor_type!=''){ echo $distributor_type.' ';}?>Distributors List <?php if($executive_name!=''){ echo ' Of '.$executive_name;}?></b></p>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'distributor_r';?>">Back</a>
    </div>
    </form>
