...
<h3 align="center">All Products <?php echo @$distributor_price_type ; ?> Price List <span style="margin-left:50px;">Effective From: <?php echo format_date($effective_from); ?></span></h3>
<br>
