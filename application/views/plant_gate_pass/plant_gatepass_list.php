                        ...
                        <div class="row">
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <a  class="btn blue tooltips" href="<?php echo SITE_URL.'plant_gate_pass';?>" data-original-title="Back to Plant Gate Pass"> <i class="fa fa-chevron-left"></i></a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                       ...
                                       <!--  <td> <?php echo $row['tanker_in_number'];?> </td> -->
                                        <td>
                                            <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo SITE_URL;?>print_plant_gate_pass_list/<?php echo cmm_encode($row['gatepass_id']); ?>">Print</a> 
                                        </td>
                                    </tr>
                                    <?php
                                    }
