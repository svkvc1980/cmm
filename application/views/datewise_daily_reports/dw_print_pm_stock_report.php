...
<h4 align="center"><?php echo get_plant_name();?> <span style="margin-left: 50px;">Daily Packing Material Report  : <?php echo 'From'.$from_date.'To'.$to_date;?> </span></h4>
...
<div class="row" style="text-align:center">
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'dw_daily_pm_stock_report_search';?>">Back</a>
</div>
