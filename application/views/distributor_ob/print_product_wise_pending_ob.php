...
<body>
        ...
        if(count($loose_oils)>0)
        {
            ...
            {   ?>
                    ...
                    <tr>
                        ...
                        <td align="right"><b>Packets</b></td>
                        <td align="right"><b>Qty in Kgs</b></td>
                        <td align="right"><b>Value in Rs.PS</b></td>
                    </tr>
                    <?php  } ?>
                    ...
                    if(count(@$do_results[@$lrow['loose_oil_id']])>0)
                    {
                        ...
                        {   
                            ...
                            <tr>
                                ...
                                <td align="right"><?php echo $dop_row['cartons']; ?> </td>
                                <td align="right"><?php echo $dop_row['packets']; ?> </td>
                                <td align="right"><?php echo $dop_row['qty_in_kgs']; ?> </td>
    ...
    <div class="wrapper" style="text-align:center">
        ...
        <a class="button print_element" href="<?php echo SITE_URL.'product_wise_pending_ob';?>">Cancel</a>
    </div>
