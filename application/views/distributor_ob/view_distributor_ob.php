		   		...
		   		<div class="col-md-12">
		   			<div class="col-md-3">
						<div class="form-group">
							<label class="control-label col-xs-6">Order Number</label>								
							<div class="col-xs-6">
	   		...
	   		<div class="row">
		   		<div class="col-md-12">
		                    	...
		                    	<?php $sn = 1;
		                    	 foreach($orderd_product_details as $row) { ?>
		                    		<tr>
		                    			...
		                    			<td align="right"><?php echo price_format($row['quantity']); ?></td>
		            ...
		            <div class="col-xs-offset-5 col-md-6">                    	
                    	<a class="btn btn-default" href="<?php echo SITE_URL.'print_distributor_ob_products'.'/'.cmm_encode(@$order_id).'/'.cmm_encode(@$order_number);?>"><i class="fa fa-print"></i> Print</a>
                    	<a class="btn btn-primary" href="<?php echo SITE_URL.'distributor_ob_list';?>">Back</a> 
                	</div>
            	</div>
            </div>
	   </div>
