        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
              <div class="portlet-body">
                <form id="" class="form-horizontal" role="form" method="post" action="<?php echo SITE_URL.'print_product_wise_pending_ob';?>">
                       ...
                       <div class="form-group">
                        <label form="inputName" class="col-sm-4 control-label">Unit <span class="font-red required_fld">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" name="print_product_wise_pending_ob" value="Submit"  class="proceed btn green">
