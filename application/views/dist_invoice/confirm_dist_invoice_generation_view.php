...
<div class="page-content-inner">
    ...
    <div class="row">
        <form class="form-horizontal" action="<?php echo SITE_URL.'insert_dist_invoice_generation';?>" method="post">
                        ...
                        <div class="portlet-body">  
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-2">
                                            <p class="form-control-static"><b><?php echo  get_distributor_invoice_number(); ?></b></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="table-scrollable">
                                                        ...
                                                        ?>
                                                            <tr class="i_row">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    $price            = $data['price'][$do_id][$order_id][$product_id];
                                                                    $items_per_carton = $data['items_per_carton'][$do_id][$order_id][$product_id];
                                                                    $lifting_qty      = $data['lifting_qty'][$do_id][$order_id][$product_id];
                                                                    $total_amount     = $price*$items_per_carton*$lifting_qty;
                                                                    $gd_total +=$total_amount;
                                                                    echo $total_amount;

                                                                    ?></span>
                                                                    <input type="hidden" name="total_price[<?php echo $do_id;?>][<?php echo $order_id?>][<?php echo $product_id?>]" value ="<?php echo $total_amount;?>" class="total_price_val">                                                                    
                                                                </td>
                                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td></td>
                                            <td>
                                                <input type="hidden" id="grand_total" class="grand_total_val" value="<?php echo $gd_total;?>" name="grand_total"><p >Grand Total &nbsp;: &nbsp;<b class="grand_total"><?php echo $gd_total;?></b></p>
                                             </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-offset-4 col-md-4">
                                    ...
                                    <!-- <a formaction="<?php echo SITE_URL.'dist_invoice_entry';?>" class="btn default">Back</a> -->
                                     <button type="submit" formaction="<?php echo SITE_URL.'dist_invoice_entry';?>" value="2" name="cancel" class="btn default">Back</button>
                                </div>
                                <!-- <div class="col-md-2">
                                    <input type="hidden" id="" class="total_lifting_qty_val" value="<?php echo $data['total_lifting_qty'];?>" name="total_lifting_qty">
                                    <p >Total Lifting Qty &nbsp;: &nbsp;<b class="total_lifting_qty"><?php echo $data['total_lifting_qty'];?></b></p>
