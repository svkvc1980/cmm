...
<div class="page-content-inner">
    ...
    <div class="row">
        <form class="form-horizontal dit_inv_generation" action="<?php echo SITE_URL.'confirm_dist_invoice_generation';?>" method="post">
                                            ...
                                            { 
                                                ...
                                                { ?>
                                                    <tr class="i_row">
                                                        ...
                                                        <?php
                                                        $lifting_qty = ($values['pending_qty']<$values['stock_qty'])?$values['pending_qty']:$values['stock_qty'];
                                                        ?><input  type="text" disabled="" tabindex="<?php echo $tab_index++;?>" class="lifting_qty inv_qty<?php echo $values['product_id']?>" data-product-id="<?php echo $values['product_id'];?>" style="width:60px"  name="lifting_qty[<?php echo $value['do_id']?>][<?php echo $values['order_id']?>][<?php echo $values['product_id']?>]" value="<?php echo  intval($lifting_qty);  ?>" ></td>
                                                        <td>
                                                        <input readonly class="stock_qty inv_stock_qty<?php echo $values['product_id']?>" style="width:60px" type="text" name="stock_qty[<?php echo $value['do_id']?>][<?php echo $values['order_id']?>][<?php echo $values['product_id']?>]" value="<?php echo intval($values['stock_qty']);?>" ></td>
                                                        <td>
