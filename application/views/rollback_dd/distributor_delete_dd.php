        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form method="post" action="<?php echo SITE_URL.'rollback_dd_delete_list';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form method="post" action="<?php echo SITE_URL.'insert_rollback_dd_delete';?>" class="form-horizontal">
                            ...
                            <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        <button type="submit" class="btn blue" onclick="return confirm('Are you sure you want to Delete DD?')"  name="submit">Submit</button>
                                        <a href="<?php echo SITE_URL.'distributor_delete_dd';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
