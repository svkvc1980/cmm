        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    <form  method="post" action="<?php echo SITE_URL.'leakage_consumption'?>">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-sm-3">
                                <button type="submit" title="Search" name="search_leakage_consumption" value="1" class="btn blue"><i class="fa fa-search"></i> </button>
                                <a  class="btn blue tooltips" href="<?php echo SITE_URL.'leakage_consumption';?>" data-original-title="Refresh"> <i class="fa fa-refresh"></i></a>
                                <button value="2" formaction="<?php echo SITE_URL.'print_leakage_consumption';?>" name="print_leakage_consumption"  class="btn blue tooltips" data-container="body" data-placement="top" data-original-title="Print"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
                        </form>
