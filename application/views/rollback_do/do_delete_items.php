        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="do_delete_items_form" method="post" action="<?php echo SITE_URL.'do_delete_items_details';?>"  class="form-horizontal">
                        <div class="row ">  
                                ...
                                <div class="form-group">
                                    <div class="col-md-5"></div>
                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo SITE_URL.'do_delete_items';?>" class="btn default">Cancel</a>
                                        </div>                                 
                                </div>
                            </div>
                        </div>
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="do_delete_items_form" method="post" action="<?php echo SITE_URL.'delete_rb_do_items';?>" class="form-horizontal">
                            ...
                            <div class="table">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><input class="ob_product" name="order_product[]" value="<?php echo $value['order_id']."_" . $value['product_id']?>" type="radio"></td>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        <button type="submit" class="btn blue"  name="submit">Delete Item</button>
                                        <a href="<?php echo SITE_URL.'do_delete_items';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
