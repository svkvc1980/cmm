        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
            		...
            		{
            		?>
	                <form method="post" name="test_report_form" action="<?php echo SITE_URL.'lab_test_report_detail';?>" class="form-horizontal test_reports">
                        <div class="row">
                           <div class="col-md-offset-3 col-md-6 well">
                                ...
                                <div class="form-group">
                                <label class="col-xs-5 control-label">Tanker In No. <span class="font-red required_fld">*</span></label>
                                    <div class="col-xs-6">
	                                    <div class="input-icon right">
	                                        <i class="fa"></i>
	                                       <input type="text" name="tank_reg_no" class="form-control" placeholder="Tanker In No">
	                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6"></div>
                                 	<div class="col-xs-6">
                                 		...
                                 		<a href="<?php echo SITE_URL.'lab_test_report';?>" class="btn default">Cancel</a>
                                	</div>                                 
                                </div>
                            </div>
                        </div>                         
