...
<body>
    ...
    <p align="center"><b>Godown stock report From <?php echo format_date($from_date); ?> TO <?php echo format_date($to_date); ?></b></p>
    <p align="center"><b>Unit : <?php echo $plant_name; ?></b></p>
    <table border="1px" align="center" width="780" cellspacing="0" cellpadding="2">
        <tr>   
    		<th rowspan="2" width="280">Product [Oil Wt]</th>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'monthly_godown_stock_report';?>">Back</a>
    </div>
