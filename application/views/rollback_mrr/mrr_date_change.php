        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="mrr_date_form" method="post" action="<?php echo SITE_URL.'mrr_date_details';?>"  class="form-horizontal">
                        <div class="row ">  
                                ...
                                <div class="form-group">
                                    <div class="col-md-5"></div>
                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo SITE_URL.'mrr_date_change';?>" class="btn default">Cancel</a>
                                        </div>                                 
                                </div>
                            </div>
                        </div>
                    ...
                    if($flag==2)
                    { ?>
                       <form id="mrr_date_form" method="post" action="<?php echo SITE_URL.'insert_mrr_date';?>" class="form-horizontal">
                            <input type="hidden" name="mrr_oil_id" value="<?php echo $mrr_list['mrr_oil_id'];?>">
                            <input type="hidden" name="existing_mrr_date" value="<?php echo $mrr_list['mrr_date'];?>">
                            <input type="hidden" name="mrr_number" value="<?php echo $mrr_list['mrr_number'] ?>">
                            <div class="row">
                            <div class="padding">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Select New MRR Date : <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-6">
