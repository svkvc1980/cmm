        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="mrr_pm_date_form" method="post" action="<?php echo SITE_URL.'mrr_pm_delete_entry_details';?>"  class="form-horizontal">
                        <div class="row ">  
                                ...
                                <div class="form-group">
                                    <div class="col-md-5"></div>
                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo SITE_URL.'mrr_pm_delete_entry';?>" class="btn default">Cancel</a>
                                        </div>                                 
                                </div>
                            </div>
                        </div>
                    ...
                    if($flag==2)
                    { ?>
                       <form id="mrr_pm_date_form" method="post" action="<?php echo SITE_URL.'update_mrr_pm_delete_details';?>" class="form-horizontal">
