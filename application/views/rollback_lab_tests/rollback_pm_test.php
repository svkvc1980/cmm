        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                ...
                <?php 
                    ...
                    {
                    ?>
	                <form method="post"  action="<?php echo SITE_URL.'get_pm_test_result';?>" class="form-horizontal">
                        <div class="row">
                           <div class="col-md-offset-3 col-md-6 well">
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-5 control-label"> PM Lab Test Number:<span class="font-red required_fld">*</span></label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                 		...
                                 		<a href="<?php echo SITE_URL.'rollback_pm_test';?>" class="btn default">Cancel</a>
                                	</div>                                 
                                </div>
                            </div>
                        </div>                         
                ...
                if(@$flag==2){
                ?>
                <form method="post" action="<?php echo SITE_URL.'update_pm_test_status';?>">
                    <div class="table-scrollable">
                        ...
                        <div class="row">
                            <div class="col-md-offset-5 col-md-3">
                                <input type="submit" class="btn blue" onclick="return confirm('Are you sure you want to Proceed?')" name="submit" value="submit">
                                <a href="<?php echo SITE_URL.'rollback_pm_test';?>" class="btn default">Cancel</a>
                            </div>
                        </div>
                    </form>    
