                ...
                <div class="portlet-body">
                    ...
                    if(isset($flg))
                    {
                        ...
                        <form id="packing_material_form" method="post" action="<?php echo $form_action;?>" class="form-horizontal">
                            ...
                            <div class="form-group">
                            <label for="inputName" class="col-sm-4 control-label">PM Code <span class="font-red required_fld">*</span></label>
                                <div class="col-sm-5">
                                    <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" class="form-control" id="pm_code" placeholder="Packing Material Code" name="pm_code" value="<?php echo @$packing_material_row['pm_code']; ?>" maxlength="150">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
