        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    <form method="post" action="<?php echo SITE_URL.'packing_material'?>"><br>
                        <div class="row">
                            <div class="col-md-6">
                                        ...
                                        <td>
                                            <select name="product_name" class="form-control">
                                                ...
                                                foreach($packing as $pack)
                                                {
                                                    ...
                                                    echo '<option value="'.$pack['packing_material_product_id'].'" '.$selected.'>'.$pack['packing_material_name'].'</option>';
                                                }
                                                ?>
                                            </select>
                                        </td>
