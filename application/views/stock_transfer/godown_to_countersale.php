    ...
    <div class="row">
       <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                ...
                {
                  ?>
                    <form id="godown_to_counter" method="post" action="<?php echo $form_action;?>"  autocomplete="on" class="form-horizontal weigh_bridge_form">
                        ...
                        <p align="right" style="color:#3A8ED6;"><b>
                            ...
                            <div class="row" id="godown">
                                <div class="col-md-12 stock_row">
                                                ...
                                                <div class="input-icon right">
                                                    ...
                                                    <select name="product[]" class="form-control product"> 
                                                        ...
                                                        <?php 
                                                            ...
                                                            {
                                                                echo '<option value="'.$pp['product_id'].'">'.$pp['product_name'].'</option>';
                                                            }
                                                        ?>
                                                    </select>
                                                </div>  
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        <label class="col-md-6 control-label">Available Pouch</label>
                                            <div class="col-md-6">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <label class="col-md-6 control-label">Transfer Qty <span class="font-red required_fld">*</span></label>
                                            <div class="col-md-6">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" name="trans_qty[]" maxlength="6" class="form-control numeric trans_qty" placeholder="Pouches">
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-4">
                                        ...
                                        <a type="sumbit" href="<?php echo SITE_URL.'godown_to_countersale';?>" value="CANCEl" class="btn default tooltips" data-container="body" data-placement="top" data-original-title="Cancel">cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form> 
                        ...
                        if(@$flag==2){?>
                        <form id="" method="post" action="<?php echo SITE_URL.'insert_godown_to_countersale';?>" autocomplete="on" class="form-horizontal">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-5 col-md-4">
                                    ...
                                    <a href="<?php echo SITE_URL.'godown_to_countersale';?>" class="btn default">Back</a>
                                </div>
                            </div>
                        </div>
                    </form>
