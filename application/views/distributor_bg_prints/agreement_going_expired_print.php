...
<html>
<head>
    <title>Agreement Going to Expired Print</title>
...
<body>
    ...
    <h4 align="center">Distributor <span style="color:#FF7300">Going to Expire</span> Agreement Details Report </h4>
    <table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
        ...
        <?php 
            if(count($agreement_going_expired)>0)
            {  
                $sn=1;
                foreach($agreement_going_expired as $row)
                { ?>
                <tr>
                    <td> <?php echo $sn++;?> </td>
