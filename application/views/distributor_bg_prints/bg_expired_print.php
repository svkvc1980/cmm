...
<html>
<head>
    <title>Bank Guarantee Expired Print</title>
...
<body>
    ...
    <h4 align="center">Distributor <span style="color:red">Expired</span> Bank Guarantee   Details Report </h4>
    <table border="1px" align="center" width="1050" cellspacing="0" cellpadding="2">
        ...
        <?php 
            if(count($bg_expired)>0)
            {  
                $sn=1;
                foreach($bg_expired as $row)
                { ?>
                <tr>
                    <td> <?php echo $sn++;?> </td>
