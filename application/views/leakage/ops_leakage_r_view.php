        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                	<form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>ops_leakage_r">
                        <div class="row">
                            <div class="col-sm-2">
                                <select name="product" class="form-control product" > 
                                    <option value="">-Select Leaked Product-</option>
                                        ...
                                        {   
                                            $selected = ($row['product_id'] == @$search_data['product_id'])?'selected':'';
                            ...
                            <div class="col-sm-3">
                                ...
                                <button type="submit" name="download_leakage" value="download" formaction="<?php echo SITE_URL;?>download_ops_leakage_r" class="btn blue tooltips btn-sm" data-container="body" data-placement="top" data-original-title="Download"><i class="fa fa-cloud-download"></i> </button>
                                <button type="submit" name="print_leakage" value="print" formaction="<?php echo SITE_URL;?>print_ops_leakage_r" class="btn blue tooltips btn-sm" data-container="body" data-placement="top" data-original-title="Print"><i class="fa fa-print"></i> </button>
	                ...
	                <div class="table-scrollable">
		                <table class="table table-bordered table-striped table-hover">
		                    ...
		                    <tbody>
                            	<?php
                            	if($ops_leakage_reports)
                            	{ 
                            		foreach ($ops_leakage_reports as $row) 
