        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="po_fg_quantity_form" method="post" action="<?php echo SITE_URL.'po_fg_quantity_details_change';?>"  class="form-horizontal">
                        <div class="row ">  
                                ...
                                <div class="form-group">
                                    <div class="col-md-5"></div>
                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo SITE_URL.'po_fg_quantity_change';?>" class="btn default">Cancel</a>
                                        </div>                                 
                                </div>
                            </div>
                        </div>
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="po_fg_quantity_form" method="post" action="<?php echo SITE_URL.'insert_po_fg_quantity_change';?>" class="form-horizontal">
                            ...
                            <div class="row ">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">New PO Quantity</label>
                                        <div class="col-md-4">
