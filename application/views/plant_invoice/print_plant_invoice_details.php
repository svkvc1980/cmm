...
<html>
<head>
	<title>Unit Invoice Print</title>
...
<div class="page">
    <div class="header">
        ...
        <table align="center" width="100%" class="data1">
            <tr>
                <td width="50%" style="height: 127px;" valign="top">
                    <div class="address">
                    <b>TO</b>
                    <br>
                    <?php echo get_plant_address($inv_products[0]['receiving_plant_id']);?>
                    <br>
                    TIN No : 37280114257<span style="margin-left: 60px;"> Phone : <?php echo @$inv_products[0]['mobile'];?></span>
                    </div>
                </td>
            ...
            <tr>
                ...
                <div class="address">
                   ...
                   <span style="margin-left: 5px;">To : <?php echo get_plant_name_not_in_session($inv_products[0]['receiving_plant_id']);?></span>
                </div>
                </td>
            </tr>
        </table>
    <div class="data2">
        <table class ="product_info" align="center" width="100%" cellspacing="0" cellpadding="2">
            <tr>
                ...
                <th width="9%" style="font-size: 12px;"><b>Units</b></th>
                <th width="9%" style="font-size: 12px;"><b>Cartons</b></th>
                <th width="12%" style="font-size: 12px;"><b>Qty in Kgs</b></th>
                <th width="12%" style="font-size: 12px;"><b>Price Per Unit</b></th>
                <th width="6%" style="font-size: 12px;"><b>Value</b></th>
                <th width="7%" style="font-size: 12px;"><b>Rate of VAT/CST</b></th>
                <th width="7%" style="font-size: 12px;"><b>VAT/CST Amount</b></th>
                <th width="12%" style="font-size: 12px;"><b>Total Value </b></th>                                       
            </tr>
            <tbody>
                <?php 
                $sno=1;
                ...
                { 
                    ...
                    { ?>
                        <tr class="i_row">
                            ...
                            <td ><span style="margin-left:3px;"> <?php echo $values['short_name']; ?></span> </td>
                            <td align="right"><span style="margin-right:3px;"><?php echo round($values['packets']); ?></span></td>
                            <td align="right"><span style="margin-right:3px;"><?php echo round($values['carton_qty']); ?></span></td>
                            
                            <td align="right"><span style="margin-right:3px;"><?php echo qty_format($values['qty_in_kg']); ?></span></td>
                            <td align="right"><span style="margin-right:3px;"><?php echo price_format($values['rate']); ?></span></td>
                            ...
                            <td align="center"> -- </td>
                            <td align="center"> -- </td>
                            <td align="right"><span style="margin-right:3px;"><?php echo price_format($values['amount']); ?></span></td>
                        </tr><?php 
                    }        
                }
               ...
               <tr>
                    ...
                    <td> </td>
                    <td> </td>                                             
                    <td align="right"><span style="margin-right:3px;"><?php echo qty_format($sum_of_qty);?></span></td>
                    <td> </td>
                    <td align="right"></td> 
                    <td> </td>
                    <td align="right"></td>
    ...
    <div class="data3">
        ...
        <tr style="height: 25px">
            <td width="50%"><span style="margin-left:3px;">Gross Wt : <b><?php echo qty_format($t_gross);?></b></span></td>
            <td width="50%" align="right"><span style="margin-right:3px;">Total : <b><?php echo price_format($t_amount);?></b></span></td>
        </tr>
        <tr style="height: 25px">
            <td width="100%" colspan="2"><span style="margin-left:3px;">
                Rupees in words : <?php echo ucfirst(convert_number_to_words(round($t_amount))); ?></span>
            </td>
        </tr>
        </table>
    </div>
...
<div class="row no-print" style="text-align:center">
    ...
    <a class="button" href="<?php echo SITE_URL.'manage_plant_invoice';?>">Cancel</a>
</div>
<br>
</body>
</html>
