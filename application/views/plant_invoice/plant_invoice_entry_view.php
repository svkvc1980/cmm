        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">                
                <div class="portlet-body">                    
                    <form id="plant_form" method="post" action="<?php echo SITE_URL.'plant_invoice_generation'?>" class="form-horizontal">
                        <div class="alert alert-danger display-hide" style="display: none;">
                            <button class="close" data-close="alert"></button> You have some form errors. Please check below. 
                        </div>
                        <div class="form-group ">
                            <!-- <label class="col-md-5 control-label mylabel">Invoice Type<span class="font-red required_fld">*</span></label> -->
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-5 col-md-6">
                                   <button type="submit" value="1" name="submit" class="btn blue">Submit</button>
                                    <a href="<?php echo SITE_URL.'manage_plant_invoice';?>" class="btn default">Cancel</a>
                                </div>
                            </div>  
                        </div>
                    </form>            
