        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    <?php if($flag==1)
                    { ?>
                    <form id="rollback_invoice_form" method="post" action="<?php echo SITE_URL.'rollback_invoice_delete';?>" class="form-horizontal">
                        <div class="row">  
                    ...
                    if($flag==2) { 
                    ?> 
                    <form id="invoice_date_form" method="post" action="<?php echo SITE_URL.'delete_invoice_details';?>" class="form-horizontal">
                    <input type="hidden" name="invoice_id" value="<?php echo $results['invoice_id']; ?>">
                        ...
                        <div class="row "> 
                            <div class="col-md-offset-5 col-md-3">
                                <button class="btn blue btn-sm" name="submit" onclick="return confirm('Are you sure you want to Delete Invoice?')" value="submit">Delete Invoice</button>
                                <a href="<?php echo SITE_URL.'delete_invoice';?>" class="btn default btn-sm">Cancel</a>
                            </div>
                        </div>
                    </form><?php
                    }
