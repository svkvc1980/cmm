        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    <?php if($flag==1)
                    { ?>
                    <form id="rollback_invoice_form" method="post" action="<?php echo SITE_URL.'date_change_details';?>" class="form-horizontal">
                        <div class="row">  
                    ...
                    if($flag==2) { 
                    ?> 
                    <form id="invoice_date_form" method="post" action="<?php echo SITE_URL.'insert_rollback_date';?>" class="form-horizontal">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $inv_ob_dates ?></td>
                                        <td><?php echo $inv_do_dates ?></td>
                        ...
                        <div class="row ">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-6 control-label"> New Invoice Date <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control date-picker date" name="new_invoice_date" data-date-format="dd-mm-yyyy" required>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'date_change';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                    </form><?php
