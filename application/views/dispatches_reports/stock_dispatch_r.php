        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
	                <form method="post" name="stock_dispatch_form" action="<?php echo SITE_URL.'product_wise_daily_dispatches_detail';?>" class="form-horizontal">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-5"></div>
                                 	<div class="col-xs-6">
                                 		...
                                 		<a href="<?php echo SITE_URL.'product_wise_daily_dispatches';?>" class="btn default">Cancel</a>
                                	</div>                                 
                                </div>
                            </div>
                        </div>                         
