...
<table style="border:none !important" align="center" width="750">
      <tr style="border:none !important">
        <td style="border:none !important">
          <span style="margin-left:0px;"><b>DETAILS OF SALE OF OILS AS ON :</b>  <?php echo format_date($from_date) ?> </span>
        </td>
     </tr>
    </table>
    ...
    <table style="border:none !important" align="center" width="750">
      <tr style="border:none !important">
        <td style="border:none !important">
          <span style="margin-left:0px;"><b>ALL EXECUTIVES SALES On</b>  <?php echo format_date($from_date) ?> </span>
        </td>
     </tr>
    </table>
    <table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'daily_sales_report_md';?>">Back</a>
    </div>
</body>
</html>
