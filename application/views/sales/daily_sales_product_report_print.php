...
<h4 align="center">Daily Product Sales report For <?php echo $plant_name .' On '.$from_date ?></h4>
  ...
  <?php  }
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'daily_product_sale_report';?>">Back</a>
    </div>
</body>
