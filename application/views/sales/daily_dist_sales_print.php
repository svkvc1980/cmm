...
<h4 align="center">Distributor Name[Code] : <?php echo $dist['agency_name'].'['.$dist['distributor_code'] .'] On '. $from_date ?></h4>
 <table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'distributor_daily_sales_report';?>">Back</a>
    </div>
</body>
