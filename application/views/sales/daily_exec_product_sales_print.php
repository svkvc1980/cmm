...
<h4 align="center">Executive  Wise Product Sales Report <span style="margin-left:50px;">Executive : <?php echo $executive_name .' On '. $from_date ?></span></h4>
  ...
  <?php  }
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'daily_exec_product_sale_report';?>">Back</a>
    </div>
</body>
