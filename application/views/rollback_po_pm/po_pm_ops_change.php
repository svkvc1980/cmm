        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="po_ops_form" method="post" action="<?php echo SITE_URL.'po_pm_ops_details_change';?>"  class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="po_pm_ops_form" method="post" action="<?php echo SITE_URL.'insert_po_pm_ops_change';?>" class="form-horizontal">
                            <input type="hidden" name="po_pm_id" value="<?php echo $po_list['po_pm_id']; ?>">
                            <input type="hidden" name="existing_ops" value="<?php echo $po_list['plant_name']; ?>">
                             <input type="hidden" name="existing_ops_id" value="<?php echo $po_list['plant_id']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Existing Plant Name :</label>
                                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Select New OPS <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-7">
                                            <select  class="form-control" name="plant_name" >
                                                <option selected value="">-Select OPS-</option>
                                                <?php 
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_pm_ops_change';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
