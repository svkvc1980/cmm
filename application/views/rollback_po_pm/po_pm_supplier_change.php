        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="po_pm_supplier_form" method="post" action="<?php echo SITE_URL.'po_pm_supplier_details_change';?>"  class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                       ...
                       ?>
                       <form id="po_pm_supplier_form" method="post" action="<?php echo SITE_URL.'insert_po_pm_supplier_change';?>" class="form-horizontal">
                            <input type="hidden" name="po_pm_id" value="<?php echo $po_list['po_pm_id']; ?>">
                            <input type="hidden" name="existing_supplier" value="<?php echo $po_list['supplier_name']; ?>">
                             <input type="hidden" name="existing_supplier_id" value="<?php echo $po_list['supplier_id']; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Select New Supplier <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-7">
                                            <select  class="form-control select2" name="supplier_name" >
                                                ...
                                                <?php 
                                                    ...
                                                    {
                                                       echo '<option value="'.$row['supplier_id'].'">'.$row['supplier_code'].'('.$row['agency_name'].')</option>';
                                                    }
                                                ?>
                                            </select> 
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_pm_supplier_change';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
