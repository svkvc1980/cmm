        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="po_pm_product_form" method="post" action="<?php echo SITE_URL.'po_delete_pm_details';?>"  class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="po_pm_product_form" method="post" action="<?php echo SITE_URL.'update_po_pm_delete';?>" class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_delete_pm';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
