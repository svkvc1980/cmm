        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="po_pm_date_form" method="post" action="<?php echo SITE_URL.'po_pm_date_details_change';?>"  class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="po_pm_date_form" method="post" action="<?php echo SITE_URL.'insert_po_pm_date_change';?>" class="form-horizontal">
                            <input type="hidden" name="po_pm_id" value="<?php echo $po_list['po_pm_id']; ?>">
                            <input type="hidden" name="existing_po_date" value="<?php echo date('Y-m-d', strtotime($po_list['po_date'])); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Existing PO Date :</label>
                                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">New PO Date <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-6">
                                            <input type="text" name="new_po_date" required class="form-control date-picker"> 
                                        </div>
                                    </div>    
                                </div>    
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_pm_date_change';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
