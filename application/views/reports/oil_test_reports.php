        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                	<form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>oil_test_r">
                        <div class="row">
                            <div class="col-sm-3">
                                <?php echo form_dropdown('loose_oil',$loose_oil,@$search_data['loose_oil'],'class="form-control" name="loose_oil"');?>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <button type="submit" name="print_lab_test_oil" value="1" formaction="<?php echo SITE_URL.'print_lab_test_oil';?>" class="btn btn-danger tooltips btn-sm" data-container="body" data-placement="top" data-original-title="Print"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
                    </form>
	                <div class="table-scrollable">
		                <table class="table table-bordered table-striped table-hover">
		                    ...
		                    <tbody>
                            	...
                            	if($oil_test_reports)
                            	{      
                            		foreach ($oil_test_reports as $row) 
                            		{ ?>
                            			<tr>
                                            ...
                                            <td><a class="btn btn-success btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Print Oil Test" href="<?php echo SITE_URL;?>download_oil_test_r/<?php echo @cmm_encode($row['lab_test_id']); ?>"><i class="fa fa-print"></i></a>
                                            </td>
                            			</tr>
                            	<?php }
                            	}
