...
<u style="margin-left:200px">Sub :- </u><p style="margin-left:240px">Submission of Leakage Claims – Reg <?php echo get_plant_name_by_id( $insurance_report[0]['ordered_plant']) ;?>. </p>
<br>
...
<br><br>
 ...
 <div class="row" style="text-align:center">
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'individual_insurance_invoice_plant';?>">Back</a>
    </div>
</body>
