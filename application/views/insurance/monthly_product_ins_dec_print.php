...
<tr>
    <td style="border:none !important" align="left">Product Wise insurance Declaration <?php if($plant_id !='') {  echo get_plant_name_by_id($plant_id); } ?>  From <?php echo date('d-m-Y', strtotime($from_date)) ?> TO <?php echo date('d-m-Y', strtotime($to_date)) ?> </td>
</tr
</table>
<br>
  ...
  <?php  }
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'monthly_product_ins_dec';?>">Back</a>
    </div>
</body>
