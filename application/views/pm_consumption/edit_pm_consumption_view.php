                    ...
                    if(isset($flg))
                    {
                        ?>
                            <form id="labtest_form" method="post" action="<?php echo $form_action;?>"  autocomplete="on" class="form-horizontal">
                                <input type="hidden" name="product_id" value="<?php echo cmm_encode($product_id);?>">
                                ...
                                <div class="well col-md-12  ">
                                    ...
                                    <?php $sno1=1; foreach ($results1 as $row) {?>
                                    <div class="row ">
                                        <div class="form-group">
                                            <div class="col-md-1">
                                                <span class=""><?php echo $sno1++;?>)</span>                                                
                                            </div>                                  
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="col-xs-6 ">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="hidden" name="pm_id1[]" value="<?php echo $row['pm_id'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="col-xs-6 ">  
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                         <input class="form-control "  value="<?php echo $row['quantity'];?>" name="quantity1[]"  type="text">
                                                         <span class=""><?php echo $row['unit_name'];?></span>   
                                                    </div>
                                                </div>
                                            </div>                                           
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="col-xs-6 ">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>   
                                                        <select class="form-control pm_id1_cls"  name="pm_id3[]"  >
                                            ...
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="col-xs-6 ">  
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                         <input class="form-control quantity1_cls"  value="" name="quantity3[]"  type="text">
                                ...
                                <div class="well col-md-12 ">
                                    ...
                                    <?php $sno2=1; foreach($results2 as $row2){?>
                                    <div class="row ">
                                        <div class="form-group">
                                            <div class="col-md-1">
                                                <span class=""><?php echo $sno2++;?>)</span>                                                
                                            </div>                                                                                                 
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="col-xs-5 ">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>   
                                                        <?php echo $row2['pm_name'];?>
                                                        <input type="hidden" name="pm_id2[]" value="<?php echo $row2['pm_id'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="col-xs-6">  
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                         <input class="form-control"  value="<?php echo $row2['quantity'];?>" name="quantity2[]"  type="text"> 
                                                         <span class=""><?php echo $row2['unit_name'];?></span>    
                                                    </div>
                                                </div>
                                            </div>                                           
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="col-xs-5 ">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>   
                                                        <select class="form-control pm_id2_cls"  name="pm_id4[]"  >
                                            ...
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="col-xs-6">  
                                                   <div class="input-icon right">
                                                        <i class="fa"></i>
                                                         <input class="form-control"  value="" name="quantity4[]"  type="text">                                                         
...
<script type="text/javascript">
    var sno1 = <?php echo ($sno1);?>;
    var sno2 = <?php echo ($sno2);?>;
</script>
