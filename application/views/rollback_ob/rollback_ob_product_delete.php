        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'rollback_ob_product_delete';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'change_rollback_ob_product_delete';?>" class="form-horizontal">
                            ...
                            <div class="row">
                             ...
                             <div class="row ">
                                ...
                                <div class=" col-md-offset-5 col-md-6">
                                    <button type="submit" class="btn blue"  name="submit">Delete Items</button>
                                    <a href="<?php echo SITE_URL.'ob_product_delete';?>" class="btn default">Cancel</a>
                                </div>
                            </div>  
