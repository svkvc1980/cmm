        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'rollback_ob_distributor';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'insert_rollback_ob_distributor';?>" class="form-horizontal">
                            ...
                            <div class="row ">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Select New Distributor</label>
                                        <div class="col-md-7">
                                            <select  class="form-control select2"  required name="distributor_id" >
                                                ...
                                                <?php 
                                                    ...
                                                    {
                                                        echo '<option value="'.$row['distributor_id'].'">'.$row['agency_name'].' ['.$row['distributor_code'].']</option>';
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'ob_distributor';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
