            ...
            <div class="portlet light portlet-fit">
                ...
                <div class="portlet-body">
                    ...
                    <form id="labtest_form" method="post" action="<?php echo $form_action;?>"  autocomplete="on" class="form-horizontal">
                        ...
                        <input type="hidden" name="test_id" value="<?php echo cmm_encode($loose_oil_test[0]['test_id']);?>">
                        <input type="hidden" name="edit_range_type_id" value="<?php echo cmm_encode($loose_oil_test[0]['range_type_id']);?>">
                                    ...
                                    <div class="col-md-4  testname">
                                        ...
                                        <div class="col-xs-10 form-group"> 
                                            <div class="input-icon right">
                                                <i class="fa"></i> 
                                                <input type="text" name="test_name"  value="<?php echo $loose_oil_test[0]['name'];?>" class="form-control input-sm" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-icon right">
                                                ...
                                                <select class="form-control"  name="test_unit"  >
                                                    ...
                                                    <?php
                                                      ...
                                                      {
                                                      $selected = (@$row['test_unit_id']==@$loose_oil_test[0]['test_unit_id'])?'selected="selected"':'';
                                           ...
                                           <div class="input-icon right">
                                                ...
                                                <select class="form-control range_type"  name="range_type"  >
                                                    ...
                                                    <?php
                                                      ...
                                                      {
                                                        $selected = (@$row['range_type_id']==@$loose_oil_test[0]['range_type_id'])?'selected="selected"':'';
                                ...
                                <div class="form-group col-md-12 textbox <?php echo $text_div;?> ">
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" name="lower_limit"   value="<?php echo @$loose_oil_test[0]['lower_limit'];?>"  class="form-control lower_limit" />
                                            </div>
                                        </div>    
                                    </div>  
                                    <div class="col-md-3 ">
                                        <div class="mt-checkbox-list ">
                                            <label class="mt-checkbox outline">
                                                <?php if($loose_oil_test[0]['lower_check']==1){?>
                                    ...
                                    <div class="col-md-3"><span class="font-red up_limit "></span>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" name="upper_limit"  value="<?php echo @$loose_oil_test[0]['upper_limit'];?>"  class="form-control upper_limit" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="mt-checkbox-list upper_check_div">
                                            <label class="mt-checkbox outline">
                                                <?php if($loose_oil_test[0]['upper_check']==1){?>
                                    ...
                                    <div class="form-group radio_dropdown <?php echo $radio_dropdown_div;?> ">
                                        <div class="col-md-12 specification">
                                            ...
                                            <div class="col-md-7 form-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input class="form-control specification_val"  value="<?php echo @$loose_oil_test[0]['specification'];?>" name="specification"  type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <?php 
                            ...
                            <div class="col-md-offset-2 col-md-9">
                                <div class="form-group exactvalue <?php echo $exactvalue_div;?> ">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input  name="exact_value" class="form-control exact_val" value="<?php echo @$loose_oil_test[0]['lower_limit'];?>"  type="text">  
                                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-5 col-md-6">
                                    ...
                                    <a href="<?php echo SITE_URL.'view_loose_oil_lab_tests/'.cmm_encode($loose_oil_test[0]['loose_oil_id']);?>" class="btn default">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
