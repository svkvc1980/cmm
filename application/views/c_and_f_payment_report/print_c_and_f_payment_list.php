...
<body>
    ...
    <p align="center"><b>C and F DD Report</b><span style="margin-left: 50px"><b>From : </b><?php echo date('d-m-Y',strtotime($search_params['from_date']));?>
    ...
    <table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
        ...
        {	
            ...
            <tr>
                ...
                <td width="250"><?php echo $key['plant_name']; ?></td>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'c_and_f_payments_R';?>">Back</a>
    </div>
</body>
