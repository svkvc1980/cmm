            ...
            <div class="portlet light portlet-fit">
              <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="col-md-5 control-label">Free Gift :</label>
                                    <div class="col-md-7">
                                        <p class="form-control-static"><b><?php echo $tanker_row['freegift_name'] ;?></b></p>                                     
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <i class="fa"></i> 
                                        <input type="text" <?php if($weight_capture_mode==1) echo 'readonly';?> class="form-control numeric weight" placeholder="Gross Weight" name="freegift_gross" maxlength="20">
                                    </div>
                                    </div>
                                    <?php
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text"  <?php if($weight_capture_mode==1) echo 'readonly';?> class="form-control numeric weight" id="tare_weight" placeholder="Tare Weight" name="freegift_tier" maxlength="20">
                                            </div>
                                        </div>
                                        <?php
                                        if($weight_capture_mode==1) // Auto
