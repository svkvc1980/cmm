            ...
            <div class="portlet light portlet-fit">
              <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="col-md-5 control-label">Packing Material :</label>
                                    <div class="col-md-7">
                                        <p class="form-control-static"><b><?php echo $tanker_row['packing_mtrl_name'] ;?></b></p>                                     
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                <label class="col-md-5 control-label">Invoice Quantity (Kg) :</label>
                                    <div class="col-md-7">
                                        <p class="form-control-static"><b><?php echo $tanker_row['invoice_quantity'] ;?></b></p>    
                                    </div>
                                </div>
                            </div>
                        </div>  
                    ...
                    else if($flag==3)
                    {
                      ...
                      {
                        ?>
                        <form method="post" action="<?php echo $form_action;?>"  autocomplete="on" class="form-horizontal weighbridge_form">
                        <div class="row">
                        <div class="col-md-offset-1 col-md-10 well">
                            <div class="col-md-offset-9 col-md-3">
                                <p align="left" style="color:#3A8ED6;"><b>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Packing MAaterial :</label>
                                        <div class="col-md-7">
                                            <p class="form-control-static"><b><?php echo $tanker_row['packing_mtrl_name'] ;?></b></p>                                     
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">Invoice Quantity (Kgs):</label>
                                        <div class="col-md-7">
                                            <p class="form-control-static"><b><?php echo $tanker_row['invoice_quantity'] ;?></b></p>    
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Tare <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-4">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
