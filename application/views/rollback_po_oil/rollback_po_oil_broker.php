        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'rollback_po_oil_broker';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'insert_rollback_po_oil_broker';?>" class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Existing Broker :</label>
                                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-offset-2 col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">New Broker <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-8">
                                            <select  class="form-control" name="broker_id" required>
                                                ...
                                                <?php 
                                                    ...
                                                    {
                                                        echo '<option value="'.$row['broker_id'].'">'.$row['agency_name'].' - ('.$row['broker_code'].') </option>';
                            ...
                            <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_oil_broker';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
