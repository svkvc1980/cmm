        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'rollback_po_oil_block';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'insert_rollback_po_oil_block';?>" class="form-horizontal">
                            <input type="hidden" name="po_oil_id" value="<?php echo $po_list['po_oil_id']; ?>">
                            <input type="hidden" name="existing_po_plant" value="<?php echo $po_list['plant_name']; ?>">
                            <input type="hidden" name="po_number" value="<?php echo $po_list['po_number'] ?>">
                            <input type="hidden" name="old_plant" value="<?php echo $po_list['plant_id'] ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row ">
                                <div class="col-md-offset-2 col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">New Plant <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-7">
                            ...
                            <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-6">
                                        ...
                                        <a href="<?php echo SITE_URL.'po_oil_block';?>" class="btn default">Cancel</a>
                                    </div>
                                </div>
                        </form><?php
                    }?>
