        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
                    ...
                    {
                      ?>
                      <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'rollback_po_oil_product';?>" class="form-horizontal">
                        <div class="row ">  
                    ...
                    { 
                      //echo "<pre>"; print_r($dd_list); exit;
                       ?>
                       <form id="dd_date_form" method="post" action="<?php echo SITE_URL.'insert_rollback_po_oil_product';?>" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Existing Oil Name :</label>
                                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label">New Oil <span class="font-red required_fld">*</span></label>
                                        <div class="col-md-7">
                                            <select  class="form-control" name="loose_oil_id" required>
                            ...
                            <div class="row">
                                <div class="col-md-offset-5 col-md-6">
                                    ...
                                    <a href="<?php echo SITE_URL.'po_oil_product';?>" class="btn default">Cancel</a>
                                </div>
                            </div>
                        </form><?php
                    }?>
