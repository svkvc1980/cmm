        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-body">
	                <form method="post"  action="<?php echo SITE_URL.'individual_dist_do_detail';?>" class="form-horizontal ">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6"></div>
                                 	<div class="col-xs-4">
                                 		...
                                 		<a href="<?php echo SITE_URL.'individual_dist_do';?>" class="btn default">Cancel</a>
                                	</div>                                 
                                </div>
                            </div>
                        </div>                         
