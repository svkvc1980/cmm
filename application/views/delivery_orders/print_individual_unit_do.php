...
<h3 align="center">Unit DO Product List</h3>
<br>
<table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">

   <tr>
        <td><b>DO Number : </b><?php  echo $unit_do[0]['do_number'] ; ?></td>
        <td><b>DO Date : </b><?php  echo date('d-m-Y',strtotime($unit_do[0]['do_date'])) ; ?></td>
   </tr>
   <tr>
        <td><b>Order Booking Number : </b><?php  echo $unit_do[0]['order_number'] ; ?></td>
        <td><b>Order Date : </b><?php  echo date('d-m-Y',strtotime($unit_do[0]['order_date'])) ; ?></td>
   </tr>
    <tr>
        <td><b>Lifting Point : </b><?php  echo $unit_do[0]['lifting_point']; ?></td>
        <td colspan="2"><b>Order For : </b><?php  echo $unit_do[0]['plant']; ?></td>
   </tr>
</table>
<br>
<table border="1px" align="center" width="750" cellspacing="0" cellpadding="2">
...
<br><br><br><br><br><br>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'individual_unit_do';?>">Back</a>
    </div>
</body>
