...
<body>
    ...
    <h4 align="center">Executive Wise Pending DOs <span style="margin-left: 50px;">From: <?php echo $from_date; ?></span>
    ...
    <a class="button print_element" href="<?php echo SITE_URL.'all_executive_pending_do';?>">Back</a>
    </div>
</body>
