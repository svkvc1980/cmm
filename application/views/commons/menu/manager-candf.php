...
<li class="menu-dropdown classic-menu-dropdown <?php if($parent_page == "#") echo 'active'; ?>">
    ...
    <ul class="dropdown-menu pull-left">
      ...
      <li class="<?php if($cur_page == "insurance_product") echo 'active'; ?>">
        <a href="<?php echo SITE_URL;?>insurance_product" class="nav-link">Insurance Product</a>
      </li>
...
<li class="menu-dropdown classic-menu-dropdown <?php if($parent_page == "reports") echo 'active'; ?>">
    ...
    <li class="dropdown-submenu <?php if(@$list_page=="sales_report") echo 'active'; ?> ">
          ...
          <ul class="dropdown-menu">
            <li class="<?php if($cur_page == "daily_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>daily_sales_report" class="nav-link">Daily Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "monthly_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>monthly_sales_report" class="nav-link">Monthly Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "daily_product_sale_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>daily_product_sale_report" class="nav-link">Daily Product Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "monthly_product_sale_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>monthly_product_sale_report" class="nav-link">Monthly Product Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "executive_daily_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>executive_daily_sales_report" class="nav-link">Executive Wise Daily Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "executive_monthly_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>executive_monthly_sales_report" class="nav-link">Executive Wise Monthly Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "daily_exec_product_sale_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>daily_exec_product_sale_report" class="nav-link"> Executive Wise Daily Product Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "monthly_exec_product_sale_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>monthly_exec_product_sale_report" class="nav-link">Executive Wise Monthly Product Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "distributor_daily_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>distributor_daily_sales_report" class="nav-link">Distributor Wise Daily Sales Report</a>
            </li>
            <li class="<?php if($cur_page == "distributor_monthly_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>distributor_monthly_sales_report" class="nav-link">Distributor Wise Monthly Sales Report</a>
            </li>
           <li class="<?php if($cur_page == "district_sales_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>district_sales_report" class="nav-link">District Wise Sales Report</a>
            </li> 
	...
	<li class="dropdown-submenu <?php if(@$list_page=="master_reports") echo 'active'; ?> ">
      ...
      <li class="<?php if($cur_page == "insurance_report") echo 'active'; ?>">
              <a href="<?php echo SITE_URL;?>insurance_report" class="nav-link">Insurance Product Report</a>
            </li>
