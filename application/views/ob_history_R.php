		...
		<div class="col-md-12">
			...
			<div class="portlet light portlet-fit">
				<div class="portlet-body">
						<form method="post" action="<?php echo SITE_URL.'ob_history_R'?>">
							<div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class=" col-sm-3">
                                    <div class="form-actions">
                                        <button type="submit" name="search_ob_history_R" value="1" class="btn blue tooltips" data-container="body" data-placement="top" data-original-title="Search"><i class="fa fa-search"></i></button>
                                        <button type="submit" name="download_ob_history_R" value="1" formaction="<?php echo SITE_URL.'download_ob_history_R';?>" class="btn blue tooltips" data-container="body" data-placement="top" data-original-title="Download"><i class="fa fa-cloud-download"></i></button>
                                        <a  class="btn blue tooltips" href="<?php echo SITE_URL.'ob_history_R';?>" data-original-title="Reset"> <i class="fa fa-refresh"></i></a>
                                    </div>
                                </div>
                            </div>
						</form>
