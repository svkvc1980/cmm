var godown = function() {
    ...
    var handlegodown = function() {

        $('#godown_to_counter').validate({
        ...
        $('#godown_to_counter input').keypress(function(e) {
            //alert('1213');
            if (e.which == 13) {
                if ($('#godown_to_counter').validate().form()) {
                    $('#godown_to_counter').submit(); //form validation success, call ajax form submit
                }
                return false;                    
            }
        });
