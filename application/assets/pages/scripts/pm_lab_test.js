var pm_lab_test = function() {

    var handlepm_lab_test = function() {

        $('.pm_lab_test').validate({
        ...
        $('.pm_lab_test input').keypress(function(e) {
            if (e.which == 13) {
                if ($('.pm_lab_test').validate().form()) {
                    $('.pm_lab_test').submit(); //form validation success, call ajax form submit
                }
                return false;                    
            }
        });
