var brokerForm = function() {

    var handlebrokerForm = function() {
        ...
        $('#broker_form input').keypress(function(e) {
            //alert('1213');
            if (e.which == 13) {
                if ($('#broker_form').validate().form()) {
                    $('#broker_form').submit(); //form validation success, call ajax form submit
                }
                return false;                    
            }
        });
