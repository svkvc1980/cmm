var ddForm = function() {
    ...
    var handleddForm = function() {
        ...
        $('#receipt_form input').keypress(function(e) {
            //alert('1213');
            if (e.which == 13) {
                if ($('#receipt_form').validate().form()) {
                    
                    $('#receipt_form').submit(); //form validation success, call ajax form submit
                }
                return false;                    
            }
        });
