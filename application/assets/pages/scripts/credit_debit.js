var credit_debitForm = function() {

    var handlecredit_debitForm = function() {
        
        $('#credit_debit_form').validate({
        ...
        $('#credit_debit_form input').keypress(function(e) {
            //alert('1213');
            if (e.which == 13) {
                if ($('#credit_debit_form').validate().form()) {
                    
                    $('#credit_debit_form').submit(); //form validation success, call ajax form submit
                }
