var add_packing_material_lab_test_form = function() {

    var handleadd_packing_material_lab_test_form= function() {

        $('#add_packing_material_lab_test_form').validate({
        ...
        $('#add_packing_material_lab_test_form input').keypress(function(e) {
            //alert('1213');
            if (e.which == 13) {
                if ($('#add_packing_material_lab_test_form').validate().form()) {
                    $('#add_packing_material_lab_test_form').submit(); //form validation success, call ajax form submit
                }
                return false;                    
            }
        });
    ...
    return {
        ...
        init: function() {
            handleadd_packing_material_lab_test_form();
        }
...
jQuery(document).ready(function() {
    add_packing_material_lab_test_form.init();
});
